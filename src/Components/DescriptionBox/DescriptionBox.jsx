    ...
    return (
        <div className='descriptionbox'>
            ...
            <div className="descriptionbox-description">
                ...
                <p>E-commerce websites typically display produts or services along with detailed descriptions, image , prices, and any available variations. Each product usually has its own dedicated page with relevant information.</p>
            </div>
        </div>
    )
}
